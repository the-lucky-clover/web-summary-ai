...
class BackgroundController {
  ...
  initializeExtension() {
    ...
    console.log('Web Summary AI - Background script loaded');
  }
    ...
    try {
      ...
      if (isRestricted) {
        ...
        await chrome.action.setTitle({
          tabId: tab.id,
          title: 'Web Summary AI - Not available on this page'
        });
      } else {
        ...
        let title = 'Web Summary AI - Click to summarize this page';
        
        // Special handling for YouTube
        if (url.hostname === 'www.youtube.com' && url.pathname === '/watch') {
          title = 'Web Summary AI - Summarize this YouTube video';
        }
