...
class RetroThemeManager {
  ...
  setupWildstyleLogo() {
    const logoContainer = this.createWildstyleLogo();
    
    // Try to insert logo in various locations
    ...
    const insertPoint = insertionPoints.find(point => point !== null);
    if (insertPoint) {
      insertPoint.insertBefore(logoContainer, insertPoint.firstChild);
    }
  }
